...
/**
 * Repository for {@link AmCalcList}<br/>
 * Available methods are.. <br/>
 * <ul>
 * <li>AmCalcList getAmCalcList(Long id);</li>
 * <li>int listAmCalcListCnt(Map<String, Object> params);</li>
 * <li>List<AmCalcList> listAmCalcList(Map<String, Object> params);</li>
 * <li>int insertAmCalcList(AmCalcList amcalclist);</li>
 * <li>int updateAmCalcList(AmCalcList amcalclist);</li>
 * <li>int deleteAmCalcList(Long id);</li>
 * </ul>
 */
@DefaultMapper
@Repository
public interface AmCalcListRepository extends AmCalcListRepository_ {
    AmCalcList getAmCalcList(Long id);

    int listAmCalcListCnt(Map<String, Object> params);
     ...
     */
    @Pageable
    List<AmCalcList> listAmCalcList(Map<String, Object> params);

    List<Long> listAmCalcListIds(Map<String, Object> params);
