...
@DefaultMapper
@Repository
public interface CategoryRepository_ {

    Category simpleGetCategory(Long id);

    int simpleListCategoryCnt(Map<String, Object> params);
     ...
     */
    @Pageable
    List<Category> simpleListCategory(Map<String, Object> params);

    int insertCategory(Category category);

    int updateCategory(Category category);

    int updateCategoryDynamic(Category category);
