...
@DefaultMapper
@Repository
public interface UserRepository_ {

    User simpleGetUser(Long id);

    int simpleListUserCnt(Map<String, Object> params);
     ...
     */
    @Pageable
    List<User> simpleListUser(Map<String, Object> params);
