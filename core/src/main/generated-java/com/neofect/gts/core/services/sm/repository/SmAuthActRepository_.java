...
/**
 * Repository for {@link SmAuthAct}
 * @see com.neofect.gts.core.services.sm.repository.SmAuthActRepository
 */
@DefaultMapper
@Repository
public interface SmAuthActRepository_ {

    SmAuthAct simpleGetSmAuthAct(Long id);

    int simpleListSmAuthActCnt(Map<String, Object> params);
     ...
     */
    @Pageable
    List<SmAuthAct> simpleListSmAuthAct(Map<String, Object> params);

    int insertSmAuthAct(SmAuthAct smAuthAct);

    int updateSmAuthAct(SmAuthAct smAuthAct);

    int updateSmAuthActDynamic(SmAuthAct smAuthAct);

    int deleteSmAuthAct(Long id);
