...
/**
 * Repository for {@link ServiceContract}
 * @see com.neofect.gts.core.services.srvce.repository.ServiceContractRepository
 */
@DefaultMapper
@Repository
public interface ServiceContractRepository_ {

    ServiceContract simpleGetServiceContract(Long id);

    int simpleListServiceContractCnt(Map<String, Object> params);
     ...
     */
    @Pageable
    List<ServiceContract> simpleListServiceContract(Map<String, Object> params);

    int insertServiceContract(ServiceContract serviceContract);

    int updateServiceContract(ServiceContract serviceContract);

    int updateServiceContractDynamic(ServiceContract serviceContract);

    int deleteServiceContract(Long id);
