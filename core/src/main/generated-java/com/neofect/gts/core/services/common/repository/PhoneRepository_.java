...
/**
 * Repository for {@link Phone}
 * @see PhoneRepository
 */
@DefaultMapper
@Repository
public interface PhoneRepository_ {

    Phone simpleGetPhone(Long id);

    int simpleListPhoneCnt(Map<String, Object> params);
     ...
     */
    @Pageable
    List<Phone> simpleListPhone(Map<String, Object> params);

    int insertPhone(Phone phone);

    int updatePhone(Phone phone);

    int updatePhoneDynamic(Phone phone);
