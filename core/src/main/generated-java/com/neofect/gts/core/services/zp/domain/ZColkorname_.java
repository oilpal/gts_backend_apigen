...
/**
 * @see com.neofect.gts.core.services.zp.domain.ZColkorname
 */
@Alias("zp_zColkorname_")
@Data
public abstract class ZColkorname_ implements Serializable {

    private static final long serialVersionUID = 1L;

    // Raw attributes
    protected String unitpart;
    protected String tblname;
    protected String colname;
    protected String colkorname;
