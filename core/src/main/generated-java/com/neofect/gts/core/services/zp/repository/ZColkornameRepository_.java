...
/**
 * Repository for {@link ZColkorname}
 * @see com.neofect.gts.core.services.zp.repository.ZColkornameRepository
 */
@DefaultMapper
@Repository
public interface ZColkornameRepository_ {

    ZColkorname simpleGetZColkorname(Long id);

    int simpleListZColkornameCnt(Map<String, Object> params);
     ...
     */
    @Pageable
    List<ZColkorname> simpleListZColkorname(Map<String, Object> params);

    int insertZColkorname(ZColkorname zColkorname);

    int updateZColkorname(ZColkorname zColkorname);

    int updateZColkornameDynamic(ZColkorname zColkorname);

    int deleteZColkorname(Long id);
