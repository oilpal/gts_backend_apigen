...
/**
 * Repository for {@link AmCodeEtc}
 * @see com.neofect.gts.core.services.am.repository.AmCodeEtcRepository
 */
@DefaultMapper
@Repository
public interface AmCodeEtcRepository_ {

    AmCodeEtc simpleGetAmCodeEtc(Long id);

    int simpleListAmCodeEtcCnt(Map<String, Object> params);
     ...
     */
    @Pageable
    List<AmCodeEtc> simpleListAmCodeEtc(Map<String, Object> params);

    int insertAmCodeEtc(AmCodeEtc amCodeEtc);

    int updateAmCodeEtc(AmCodeEtc amCodeEtc);

    int updateAmCodeEtcDynamic(AmCodeEtc amCodeEtc);

    int deleteAmCodeEtc(Long id);
