package com.neofect.gts.core.services.config;
...
import com.unvus.config.mybatis.support.LegacyMapper;
...
public abstract class MyBatisConfig extends UnvusMyBatisConfig {
    ...
    public static final String BASE_PACKAGE = "com.unvus.iflex.core";
    public static final String TYPE_ALIASES_PACKAGE = "com.unvus.iflex.core";
    public static final String TYPE_HANDLER_PACKAGE = "com.unvus.config.mybatis.type";
...
class DefaultMyBatisConfig extends MyBatisConfig {
	...
	protected Interceptor[] getInterceptors() {
		return new Interceptor[]{new PaginationInterceptor(), new AuditingInterceptor()};
	}
}
